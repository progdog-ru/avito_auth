...
'token_type' => 'getTokenType'    ];
     ...
     * Sets access_token
     *
     * @param string $access_token Новый ключ для временной авторизации в системе
     *
     * @return $this
     */
     ...
     * Sets expires_in
     *
     * @param float $expires_in Время жизни ключа в секундах
     *
     * @return $this
     */
     ...
     * Sets refresh_token
     *
     * @param string $refresh_token Новый ключ для обновления токена доступа
     *
     * @return $this
     */
     ...
     * Sets scope
     *
     * @param string $scope Полученный скоуп
     *
     * @return $this
     */
     ...
     * Sets token_type
     *
     * @param string $token_type Тип ключа авторизации
     *
     * @return $this
     */
